...
class TaskController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function service(Request $request, TaskService $taskService): JsonResponse
    {
        $result = $taskService->getListByService($request->user());
     ...
     * @return JsonResponse
     */
    public function serviceDetail(string $id, Request $request, TaskService $taskService): JsonResponse
    {
        $rules = [
            'id' => 'exists_plus:tasks,id,' . $request->user()->id . ',user_id'
        ];
        $messages = [
            'id.exists_plus' => __('task.service.detail.id.exists_plus')
        ];
        ...
        $result = $taskService->serviceDetail($request->user(), $id);
     ...
     * @return JsonResponse
     */
    public function serviceUpdate(string $id, Request $request, TaskService $taskService): JsonResponse
    {
        $rules = [
            'id' => 'exists_plus:tasks,id,' . $request->user()->id . ',user_id',
            'item_id' => 'required|exists_plus:task_items,id,' . $id . ',task_id',
        ...
        $messages = [
            'id.exists_plus' => __('task.service.update.id.exists_plus'),
            'item_id.required' => __('task.service.update.item_id.required'),
            'item_id.exists_plus' => __('task.service.update.item_id.exists_plus'),
            'content.required' => __('task.service.update.content.required'),
            'content.in' => __('task.service.update.content.in'),
            'remark.max' => __('task.service.update.remark.max'),
            'options.required_if' => __('task.service.update.options.required_if'),
            'number.required_if' => __('task.service.update.number.required_if'),
            'status.required_if' => __('task.service.update.status.required_if'),
            'scope.required_if' => __('task.service.update.scope.required_if'),
            'ira.required_if' => __('task.service.update.ira.required_if'),
            'description.required_if' => __('task.service.update.description.required_if'),
            'image.required_if' => __('task.service.update.image.required_if'),
            'picture.required_if' => __('task.service.update.picture.required_if'),
            'options.array' => __('task.service.update.options.array'),
            'number.max' => __('task.service.update.number.max'),
            'status.integer' => __('task.service.update.status.integer'),
            'scope.max' => __('task.service.update.scope.max'),
            'ira.max' => __('task.service.update.ira.max'),
            'description.max' => __('task.service.update.description.max'),
            'image.array' => __('task.service.update.image.array'),
            'picture.array' => __('task.service.update.picture.array'),
            'image.*.image' => __('task.service.update.image.*.image'),
            'picture.*.image' => __('task.service.update.picture.*.image'),
        ];
        $validator = Validator::make(array_merge([
            'id' => $id
        ], $request->all()), $rules, $messages);
        ...
        $result = $taskService->serviceUpdate($request->user(), $id, $data);
    ...
    public function serviceAll(string $id, Request $request, TaskService $taskService): JsonResponse
    {
        $rules = [
        ...
        $messages = [
            'id.exists_plus' => __('task.service_all.id.exists_plus'),
            'item_id.exists_plus' => __('task.service_all.item_id.exists_plus')
        ];
        $validator = Validator::make(array_merge([
            'id' => $id
        ...
        $result = $taskService->serviceAll($request->user(), $id, $data);
        return $this->success($result);
    }
    ...
    public function serviceReset(string $id, Request $request, TaskService $taskService): JsonResponse
    {
        $rules = [
            'id' => 'exists_plus:tasks,id,3,type',
            'item_id' => 'exists_plus:task_items,id,' . $id . ',task_id'
        ...
        $result = $taskService->serviceReset($request->user(), $id, $data);
        return $this->success($result);
    }
    ...
    public function serviceItemDetail(string $id, Request $request, TaskService $taskService): JsonResponse
    {
        $rules = [
            'id' => 'exists_plus:tasks,id,3,type',
            'item_id' => 'exists_plus:task_items,id,' . $id . ',task_id'
        ...
        $result = $taskService->serviceItemDetail($request->user(), $id, $data);
        return $this->success($result);
    }
