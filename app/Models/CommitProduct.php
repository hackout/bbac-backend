 ...
 * @property-read ?Collection<CommitProductItem> $items 考核项
 * @property-read ?Collection<CommitApprove> $approves 审核记录
 */
class CommitProduct extends Model
{
     ...
     *
     * @author Dennis Lui <hackout@vip.qq.com>
     * @return null|Collection<CommitProductItem>|HasMany
     */
    public function items()
    {
        return $this->hasMany(CommitProductItem::class);
    }
