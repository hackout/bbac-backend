 ...
 * @property string $document_id 指导书ID
 ...
 * @property-read Document $document 指导书
 * @property-read Collection<Media> $media 附件
 * @property-read User $user 最近操作用户
 */
class DocumentLog extends Model implements HasMedia
{
     ...
     *
     * @author Dennis Lui <hackout@vip.qq.com>
     * @return null|Document|BelongsTo|Model
     */
