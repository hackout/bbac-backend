 ...
 * @property ?string $issue_vehicle_id 提交人ID
...
class IssueVehicleLog extends Model implements HasMedia
{
     ...
     *
     * @author Dennis Lui <hackout@vip.qq.com>
     * @return null|BelongsTo<IssueVehicle>|IssueVehicle|BelongsTo
     */
    public function issue()
    {
        return $this->belongsTo(IssueVehicle::class);
    }
