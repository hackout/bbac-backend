...
return new class extends Migration {
    ...
    {
        Schema::create('examine_inlines', function (Blueprint $table) {
            ...
            $table->uuid('commit_inline_id')->nullable()->comment('更新版本ID');
    ...
    {
        Schema::dropIfExists('examine_inlines');
    }
};
