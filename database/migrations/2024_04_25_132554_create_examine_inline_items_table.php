...
return new class extends Migration
{
    ...
    {
        Schema::create('examine_inline_items', function (Blueprint $table) {
            $table->uuid('id')->primary()->unique()->comment("主键");
            $table->uuid('examine_inline_id')->nullable()->comment('在线考核-模板ID');
            $table->uuid('commit_inline_item_id')->nullable()->comment('考核项历史ID');
    ...
    {
        Schema::dropIfExists('examine_inline_items');
    }
};
