...
return new class extends Migration
{
    ...
    {
        Schema::create('commit_inlines', function (Blueprint $table) {
            ...
            $table->uuid('examine_inline_id')->nullable()->comment('应用考核ID');
    ...
    {
        Schema::dropIfExists('commit_inlines');
    }
};
