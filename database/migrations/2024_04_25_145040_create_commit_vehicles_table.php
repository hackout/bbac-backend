...
return new class extends Migration
{
    ...
    {
        Schema::create('commit_vehicles', function (Blueprint $table) {
            ...
            $table->uuid('examine_vehicle_id')->nullable()->comment('应用考核ID');
    ...
    {
        Schema::dropIfExists('commit_vehicles');
    }
};
