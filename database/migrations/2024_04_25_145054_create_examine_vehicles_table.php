...
return new class extends Migration
{
    ...
    {
        Schema::create('examine_vehicles', function (Blueprint $table) {
            ...
            $table->uuid('commit_vehicle_id')->nullable()->comment('更新版本ID');
    ...
    {
        Schema::dropIfExists('examine_vehicles');
    }
};
