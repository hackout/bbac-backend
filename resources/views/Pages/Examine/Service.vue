<template>
    <Layout>
        ...
        <div class="page-block">
            ...
            <DataTable ref="table" :apiName="$route('commit.list', { type: 'service' })"
...
export default {
    ...
    methods: {
        viewDetail(item){
            ...
            this.$nextTick(()=>{
                this.$refs.DetailDialog.open('service',item)
            })
        },
        approveItem(item){
        ...
        addItemByType(type) {
            ...
            this.$nextTick(() => {
                this.$refs.SaveDialog.open('add', 'service', type)
            })
        },
        addItem() {
        ...
        editItem(item) {
            ...
            this.chooseAddVisit = false
            this.$nextTick(() => {
                this.$refs.SaveDialog.open('edit', 'service', item.sub_type, item)
            })
        },
        viewItem(item) {
            this.viewable = true
            this.$nextTick(() => {
                this.$refs.ItemDrawer.open('service', item)
            })
        },
        importSuccess() {
