<template>
    <Layout>
        ...
        <DetailDialog ref="DetailDialog" :examine_product_item_type="examine_product_item_type" v-if="DetailDialogVisit"
            @success="refreshData" @closed="DetailDialogVisit = false"></DetailDialog>
    </Layout>
</template>
<script>
