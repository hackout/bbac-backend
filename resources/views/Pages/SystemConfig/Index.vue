  ...
  <Layout>
    ...
    <div class="page-block">
      <el-form ref="form" :model="form" :rules="formRules" label-width="200px" size="large">
        ...
        <el-form-item label="整车问题时效" prop="vehicle_due">
          <el-input type="number" v-model="form.vehicle_due"></el-input>
          <div class="el-form-item-msg">整车服务,提交问题后的自动标注处理时效,单位天</div>
        </el-form-item>
        <el-form-item>
  ...
  data() {
    return {
      form: {
        ...
        vehicle_due: this.item.vehicle_due,
      },
      formRules: {
        captcha_switch: [
        ...
        default_period: [
          { required: true, trigger: 'blur', message: '员工基础工时不能为空' },
        ],
        vehicle_due: [
          { required: true, trigger: 'blur', message: '整车服务-处理时效不能为空' },
        ]
      }
    }
  },
